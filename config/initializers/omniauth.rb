...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, APP_CONFIG['google_key'], APP_CONFIG['google_secret'], :name => 'google', :scope => 'userinfo.email,userinfo.profile,https://mail.google.com/mail/feed/atom/,https://www.google.com/m8/feeds,plus.me,plus.login'
